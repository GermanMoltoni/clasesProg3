<?php
    ...
    if(file_exists($path))
    {
        ...
        foreach($listado as $conteiner)
           $tabla.="<tr><td>".$conteiner->numero."</td><td>".$conteiner->descripcion."</td><td>".$conteiner->pais."</td><td>"."<img src='".$conteiner->foto."' class=''alt='' width='50'></td><td><button name='baja' onClick='baja()'class='btn btn-danger navbar-btn'>Baja</button></td></tr>";
